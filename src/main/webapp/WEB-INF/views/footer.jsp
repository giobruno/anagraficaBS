<!-- FOOTER -->
		...
		<tr height="13px">
			<td align="left" >
				<a href="javascript:void(0);"  style="font-size: 10px; font-family: Verdana;color:white;font-weight:bold;"
